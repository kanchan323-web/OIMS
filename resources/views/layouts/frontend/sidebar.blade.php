        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                @if (auth()->guard('admin')->check())
                    ...
                    <li class=" ">
                        <a href="#rig-users" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            ...
                            <span class="ml-4">Rig Users</span>
                            <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <ul id="rig-users" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                <a href="{{route('admin.rig_users.index')}}">
                                    <i class="las la-minus"></i><span>Rig Users</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{route('admin.rig_users.create')}}">
                                    <i class="las la-minus"></i><span>Add Rig Users</span>
                                </a>
                            </li>
                        </ul>
                    </li>
