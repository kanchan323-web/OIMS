...
@section('page-content')
    ...
    <div class="content-page">
        <div class="container-fluid add-form-list">
            <div class="row">
                <div class="col-sm-12">
                    {{Breadcrumbs::render('edit_edp',$editData->id)}}
                            ...
                            <form action="{{ route('admin.edp.update') }}" method="POST" class="needs-validation"
                                ...
                                <div class="form-row">
                                        ...
                                        <select class="form-control" name="section" required>
                                            ...
                                            @foreach ($section_list as $section)
                                                <option value="{{ $section->section_name }}"
                                                    {{ $editData->section == $section->section_name ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea class="form-control" name="description" rows="3" required>{{ $editData->description }}</textarea>
                                    </div>
