@extends('layouts.frontend.admiin_layout')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate method="POST" action="{{ route('admin.stock.import') }}"
                                ...
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-2 mb-3 d-flex align-items-end">
                                        <a href="{{ route('admin.stock.downloadSample') }}" class="ml-1 text-primary">
