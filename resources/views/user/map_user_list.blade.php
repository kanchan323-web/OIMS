...
@section('page-content')
  ...
  <div class="content-page">
    ...
    @endif
      ...
      <div class="table-responsive rounded mb-3">
        ...
        <tr class="user-row" data-id="{{$userData->id}}" data-email="{{$userData->email}}"
        data-user-type="{{$userData->user_type}}" data-rig-id="{{$userData->rig_id}}">
  ...
  <div class="modal fade" id="noDataFoundModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="noDataFoundLabel" aria-hidden="true">
