                    ...
                    <div class="login-card">
                        <div class="login-header">
                            <div class="brand-logo back-link text-decoration-none d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('resources/images/login/lock.svg') }}" alt="Admin Icon" class="brand-logo-img">
                        ...
                        <div class="login-body">
                            ...
                            <div class="text-center mt-3">
                                <p class="small text-muted">Need help? <a href="#" class="text-primary">Contact support</a></p>
                            </div> --}}
                        </div>
                    </div>
                </div>
